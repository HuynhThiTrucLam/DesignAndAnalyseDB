            ...
            <TableCell>
              <Chip
                sx={{
                  ...
                  pr: "4px",
                  backgroundColor:
                    index < 3 ? getChipColor(index) : "transparent", // Top 1 and Top 2 have colors, others transparent
                  color: index < 2 ? "#fff" : "#000", // Top 1 and Top 2 have white text, others black
                  fontSize: "14px",
                  fontWeight: "600",
                }}
                size="medium"
